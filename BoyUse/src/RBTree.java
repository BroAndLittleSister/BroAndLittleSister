			...
			if (uncle.colour == Colour.RED) {
				...
				if (left) {
					...
					if (x.parent.parent.parent!=null){
						boolean side=x.parent.parent.value==x.parent.parent.parent.r.value;
						if (side)
							x.parent.parent.parent.r=x.parent;
						else
							x.parent.parent.parent.l=x.parent;
						Node<T> upper=x.parent.parent.parent;

						x.parent.parent.parent=x.parent;
						x.parent.parent.l=x.parent.r;
						x.parent.r.parent=x.parent.parent;
						x.parent.r=x.parent.parent;


						x.parent.parent=upper;
					}
					else {
						x.parent.parent.parent=x.parent;
						x.parent.parent.l=x.parent.r;
					...
					if (x.parent.parent.parent!=null){
						...
						x.parent.parent.parent=x.parent;
						x.parent.parent.r=x.parent.l;
						x.parent.l.parent=x.parent.parent;
						x.parent.l=x.parent.parent;
